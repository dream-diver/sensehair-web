        ...
        <div className="row">
          <div className="col py-5" data-aos="fade-up" data-aos-duration="750" data-aos-delay="500" data-aos-once="true">
            ...
            <ul className="font-1-5x">
              <li>{ state.text.careerInfoListTextItem1 }</li>
              <li>{ state.text.careerInfoListTextItem2 }</li>
              <li>{ state.text.careerInfoListTextItem3 }</li>
              <li>{ state.text.careerInfoListTextItem4 }</li>
